    ...
    <div class="flex-1 container mx-auto px-6 py-8">
        <div class="max-w-3xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-300">${salle != null ? 'Modifiez les informations de la salle' : 'Ajoutez une nouvelle salle à votre système'}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
                <form method="post" action="${pageContext.request.contextPath}/salles" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-2">
                            <label for="capacite" class="block text-sm font-bold text-gray-700">Capacité *</label>
                        ...
                        <div class="space-y-2">
                            <label for="equipements" class="block text-sm font-bold text-gray-700">Équipements</label>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-4">
                        <button type="submit"
                            ...
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="${salle != null ? 'M5 13l4 4L19 7' : 'M12 4v16m8-8H4'}"/>
                            </svg>
