...
@NamedQueries({
        ...
        @NamedQuery(name = "Reservation.findBySalle", query = "SELECT r FROM Reservation r WHERE r.salle.id = :salleId AND r.statut != 'ANNULEE' ORDER BY r.dateDebut"),
        @NamedQuery(name = "Reservation.findFuture", query = "SELECT r FROM Reservation r WHERE r.dateDebut >= :now AND r.statut != 'ANNULEE' ORDER BY r.dateDebut"),
        @NamedQuery(name = "Reservation.findOverlapping", query = "SELECT r FROM Reservation r WHERE r.salle.id = :salleId "
                +
                "AND r.id != :excludeId " +
