 ...
 * Peuple la base de données avec des utilisateurs, salles et réservations de
 * test.
 */
@WebListener
    ...
    private void createSalles(SalleService salleService) {
        ...
        if (salleService.getAllSalles().isEmpty()) {
            salleService.createSalle(
                    ...
                    "uploads/images/conference_a.jpg",
                    "uploads/videos/conference_meeting.mp4",
                    "Batiment A, 2ème étage, Aile Nord");
            ...
            salleService.createSalle(
                    ...
                    "uploads/images/meeting_b.jpg",
                    "uploads/videos/test_video.mp4",
                    "Batiment B, 1er étage, Salle 102");
            ...
            salleService.createSalle(
                    ...
                    "uploads/images/training_c.jpg",
                    "uploads/videos/presentation.mp4",
                    "Centre de Formation, Salle F-03");
            ...
            salleService.createSalle(
                    ...
                    "uploads/images/executive.jpg",
                    "uploads/videos/conference_meeting.mp4",
                    "Tour Principale, 25ème étage, Vue Mer");
            ...
            salleService.createSalle(
                    ...
                    "uploads/images/collab.jpg",
                    "uploads/videos/test_video.mp4",
                    "Open Space, Zone Créative");
            ...
            salleService.createSalle(
                    ...
                    "uploads/images/amphitheater.jpg",
                    "uploads/videos/presentation.mp4",
                    "Centre de Conférences, Rez-de-chaussée");
